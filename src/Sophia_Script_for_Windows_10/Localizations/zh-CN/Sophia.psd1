...
ESUProgramEnrollment                      = Windows 10 将于 2025 年 10 月 14 日停止支持。您的电脑可能会受到恶意软件、木马和零日漏洞的威胁。您是否希望注册"消费者扩展安全更新 (ESU)"计划，通过 Microsoft Activation Scripts (MAS) 提供的 TSforge 继续接收更新直至 2028 年？
...
HEVCInstalled                             = 设备制造商提供的HEVC视频扩展已安装。
HEVCInstallNotification                   = 正在安装设备制造商提供的HEVC视频扩展程序......
