...
UnsupportedOSBuild                        = El script sólo es compatible con Windows 10 22H2. Estás usando Windows {0} {1}. Actualiza tu Windows e inténtalo de nuevo.
...
HEVCInstalled                             = Extensiones de vídeo HEVC del fabricante ya está instalado.
HEVCInstallNotification                   = Se está instalando Extensiones de vídeo HEVC del fabricante del dispositivo...
