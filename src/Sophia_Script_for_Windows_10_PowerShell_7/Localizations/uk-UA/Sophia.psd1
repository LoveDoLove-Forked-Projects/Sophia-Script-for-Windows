...
UnsupportedOSBuild                        = Скрипт підтримує тільки Windows 10 22H2. Ви використовуєте {0} {1}. Оновіть Windows і спробуйте ще раз.
...
HEVCInstallNotification                   = Розширення відео HEVC від виробника пристрою встановлюється...
